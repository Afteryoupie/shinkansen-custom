...
$WatchdogScript = Join-Path $PSScriptRoot "llm_watchdog_win.py"
...
Start-Process -FilePath $Pythonw -ArgumentList "`"$WatchdogScript`"" -WorkingDirectory $RootDir -WindowStyle Hidden
